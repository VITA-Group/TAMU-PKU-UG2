import argparse
import os
from DeblurGAN.util import util
import torch
...
class BaseOptions():
	...
	def initialize(self):
		self.parser.add_argument("--in_path", default="sample/evaluation-images/", help="input image/directory path")
		self.parser.add_argument("--out_path", default="sample/evaluation-images_deblurGAN/",help="output image/directory path")

		# self.parser.add_argument('--dataroot', required=True, help='path to images (should have subfolders trainA, trainB, valA, valB, etc)')
		self.parser.add_argument('--dataroot', default='./dataset/blurred/part1/', help='path to images (should have subfolders trainA, trainB, valA, valB, etc)')
		...
		self.parser.add_argument('--learn_residual', action='store_false', help='if specified, model would learn only the residual to the input')
		...
		self.parser.add_argument('--name', type=str, default='pre-trained', help='name of the experiment. It decides where to store samples and models')
		...
		self.parser.add_argument('--checkpoints_dir', type=str, default='./DeblurGAN/checkpoints', help='models are saved here')
